...
export function EmailTemplateEditorModal({
  ...
  const getTitle = () => {
    if (isCustomizeMode) return t('emailSettings.customizeTemplate');
    if (isEditMode) return t('emailSettings.editTemplate');
    return t('emailSettings.createTemplate');
  };
        ...
        <div className="flex-1 overflow-y-auto space-y-6 py-4">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="slug">
                  {t('emailSettings.slug')}{' '}
                  <span className="text-muted-foreground text-xs">
                    ({t('emailSettings.autoGenerated')})
                  </span>
                </Label>
                <Input
                  id="slug"
            ...
            <div className="space-y-2">
              <Label htmlFor="description">{t('emailSettings.description')}</Label>
              <Textarea
                id="description"
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <Label htmlFor="subject">{t('emailSettings.subjectLine')} *</Label>
          ...
          {/* Email Body */}
          <div className="space-y-2">
            <Label>{t('emailSettings.emailBody')} *</Label>
            <Tabs value={bodyTab} onValueChange={(v) => setBodyTab(v as 'html' | 'text')}>
              <TabsList>
                <TabsTrigger value="html">{t('emailSettings.richTextEditor')}</TabsTrigger>
                <TabsTrigger value="text">{t('emailSettings.plainText')}</TabsTrigger>
              </TabsList>
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-2">
                    ...
                    <Label htmlFor="autoGenerateText" className="text-sm font-normal">
                      {t('emailSettings.autoGenerateFromHtml')}
                    </Label>
                  </div>
                  <Textarea
          ...
          <Button onClick={handleSave} disabled={loading}>
            {loading ? (
              ...
              <>
                ...
                {isCustomizeMode ? t('emailSettings.saveCustomization') : t('emailSettings.saveTemplate')}
              </>
            )}
          </Button>
        </DialogFooter>

...
DROP POLICY IF EXISTS "Users can view extracted entities in their organization" ON extracted_entities;
DROP POLICY IF EXISTS "Users can insert extracted entities in their organization" ON extracted_entities;
DROP POLICY IF EXISTS "Users can update extracted entities in their organization" ON extracted_entities;
DROP POLICY IF EXISTS "Users can delete extracted entities in their organization" ON extracted_entities;
DROP POLICY IF EXISTS "Service role can manage extracted entities" ON extracted_entities;
...
CREATE POLICY "Service role can manage extracted entities"
  ON extracted_entities FOR ALL
  TO service_role
  USING (true)
  WITH CHECK (true);
